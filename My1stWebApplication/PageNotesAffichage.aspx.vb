...
Public Class PageNotesAffichage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
          'On afficher la promo,groupe et la section du l'étudiant connecté a gauche de la page
        cnx2.Open()
	...
	'Cette procedure sert a renvoyé l'étudiant a la page du changement du mot de pass
	...
	'Cette procedure sert a déconnecter l'étudiant et vider les variables session
        Session.RemoveAll()
        Response.Redirect("LoginOfficiel.aspx")
    End Sub
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
	    'Cette procedure sert a envoyer une réclamation par l'étudiant a l'enseignant concerné par le module qui se trouve sur la meme ligne ou l'étudiant a cliquer sur réclamer
        ...
        'On récupere le nom d'utilisteur du l'enseignant concerné par le module qui se trouve la meme ligne que le lien réclamer cliqué dans le gridview
        ...
        dr.Close()
		'On récupere l'adresse mail du l'enseignant
    ...
    Protected Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        'On récupere le mail écrit par l'étudiant dans la fenetre affiché 
        ...
        'On envoie le message a l'enseignant concerné 
            client.Send(Message)
        Else
